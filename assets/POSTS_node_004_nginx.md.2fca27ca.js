...
<span class="line"></span></code></pre></div><h3 id="停止" tabindex="-1">停止 <a class="header-anchor" href="#停止" aria-hidden="true">#</a></h3><div class="vp-code-group"><div class="tabs"><input type="radio" name="group-w3jfE" id="tab-6PDg2lQ" checked="checked"><label for="tab-6PDg2lQ">强制停止</label><input type="radio" name="group-w3jfE" id="tab-p0ABCL9"><label for="tab-p0ABCL9">退出</label></div><div class="blocks"><div class="language-shell active"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#FFCB6B;">nginx</span><span style="color:#A6ACCD;"> </span><span style="color:#C3E88D;">-s</span><span style="color:#A6ACCD;"> </span><span style="color:#C3E88D;">stop</span></span>
...
<span class="line"><span style="color:#676E95;font-style:italic;">#	}</span></span>
<span class="line"><span style="color:#676E95;font-style:italic;">#}</span></span>
<span class="line"></span></code></pre></div></div></div><p>其中 nginx.conf 又引入了 /etc/nginx/sites-enabled/*, 而我们实际需要配置的就是 /etc/nginx/sites-enabled/default 文件。</p><div class="vp-code-group"><div class="tabs"><input type="radio" name="group-e-XTH" id="tab-co7N_rU" checked="checked"><label for="tab-co7N_rU">default</label><input type="radio" name="group-e-XTH" id="tab-tCmfnN8"><label for="tab-tCmfnN8">default 示例</label></div><div class="blocks"><div class="language-shell active"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#82AAFF;">cd</span><span style="color:#A6ACCD;"> </span><span style="color:#C3E88D;">/etc/nginx/sites-enabled</span></span>
