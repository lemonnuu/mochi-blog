...
<span class="line"></span></code></pre></div><h3 id="停止" tabindex="-1">停止 <a class="header-anchor" href="#停止" aria-hidden="true">#</a></h3><div class="vp-code-group"><div class="tabs"><input type="radio" name="group-__Fmf" id="tab-PGb7Wla" checked="checked"><label for="tab-PGb7Wla">强制停止</label><input type="radio" name="group-__Fmf" id="tab-6L49T4u"><label for="tab-6L49T4u">退出</label></div><div class="blocks"><div class="language-shell active"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#FFCB6B;">nginx</span><span style="color:#A6ACCD;"> </span><span style="color:#C3E88D;">-s</span><span style="color:#A6ACCD;"> </span><span style="color:#C3E88D;">stop</span></span>
...
<span class="line"><span style="color:#676E95;font-style:italic;">#	}</span></span>
<span class="line"><span style="color:#676E95;font-style:italic;">#}</span></span>
<span class="line"></span></code></pre></div></div></div><p>其中 nginx.conf 又引入了 /etc/nginx/sites-enabled/*, 而我们实际需要配置的就是 /etc/nginx/sites-enabled/default 文件。</p><div class="vp-code-group"><div class="tabs"><input type="radio" name="group-e8KFV" id="tab-2YgH_K1" checked="checked"><label for="tab-2YgH_K1">default</label><input type="radio" name="group-e8KFV" id="tab-BIXdkjQ"><label for="tab-BIXdkjQ">default 示例</label></div><div class="blocks"><div class="language-shell active"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#82AAFF;">cd</span><span style="color:#A6ACCD;"> </span><span style="color:#C3E88D;">/etc/nginx/sites-enabled</span></span>
