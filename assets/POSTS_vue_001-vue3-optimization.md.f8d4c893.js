...
<span class="line"></span></code></pre></div><p>这里 Flow 并没有正确推导出 vm.$options.props 的类型, 从而开发人员不得不强制申明 propsOptions 的类型为 any, 显得很不合理。</p><p>而 TypeScript 提供了更好的类型检查, 能支持复杂的类型推导。源码使用 TypeScript 编写, 也省去了单独维护 d.ts 文件的麻烦。就整个 TypeScript 的生态来看, TypeScript 团队也是越做越好, TypeScript 本身保持着一定频率的迭代和更新, 支持的 feature 也越来越多。</p><h2 id="性能优化" tabindex="-1">性能优化 <a class="header-anchor" href="#性能优化" aria-hidden="true">#</a></h2><h3 id="源码体积优化" tabindex="-1">源码体积优化 <a class="header-anchor" href="#源码体积优化" aria-hidden="true">#</a></h3><p>我们知道, JavaScript 包体积越小, 意味着网络传输时间越短, JavaScript 引擎解析包的速度也越快。所以 Vue3 优化了引入源码的包体积大小:</p><ul><li>移除了一些冷门的 feature (例如 filter、inline-template 等)</li><li>支持 tree shaking, 减少打包体积</li></ul><h3 id="数据劫持优化" tabindex="-1">数据劫持优化 <a class="header-anchor" href="#数据劫持优化" aria-hidden="true">#</a></h3><h3 id="编译优化" tabindex="-1">编译优化 <a class="header-anchor" href="#编译优化" aria-hidden="true">#</a></h3>`,24),t=[o];function c(r,i,C,A,d,y){return n(),a("div",null,t)}const m=s(l,[["render",c]]);export{h as __pageData,m as default};
